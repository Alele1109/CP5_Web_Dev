...
const destaques = [
  {
    ...
    description: 'O mais vendido da loja, diversão garantida para toda a família.',
    price: 149.9,
    oldPrice: 199.9,
  ...
  },
  {
    ...
    description: 'Versão limitada com acabamento premium para colecionadores.',
    price: 349.9,
    oldPrice: 399.9,
    category: 'Destaque',
    image: jogo,
  ...
  return (
    <div>
      ...
      <section
        ...
        style={{
          background:
            'radial-gradient(ellipse 80% 60% at 50% -10%, var(--accent-bg) 0%, transparent 70%)',
        }}
      >
      ...
      {/* DESTAQUES */}
      <section className="px-7 py-14 max-w-6xl mx-auto">
